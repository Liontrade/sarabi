import {
    COMPANY_LABEL, FEATURES_LABEL,
    RESOURCES_LABEL, LEGAL_LABEL,

    ABOUT_US, CAREERS, PRESS, CONTACT,
    AI_PREDICTIONS, LIVE_INSIGHTS, PORTFOLIO_MANAGEMENT, CUSTOM_ALERTS,
    BLOG, TUTORIALS, FAQ, HELP_CENTER,
    TERMS_OF_SERVICE, PRIVACY_POLICY, COOKIE_POLICY,
} from '../strings';

import {
    ABOUT_US_URL, CAREERS_URL, PRESS_URL, CONTACT_URL,
    AI_PREDICTIONS_URL, LIVE_INSIGHTS_URL, PORTFOLIO_MANAGEMENT_URL, CUSTOM_ALERTS_URL,
    BLOG_URL, TUTORIALS_URL, FAQ_URL, HELP_CENTER_URL,
