...
export const RECOMMENDED_STOCKS: Stock[] = [
    ...
    { ticker: 'AAPL', name: 'Apple Inc.', price: '$150', change: '+5.0%', logo: aaplLogo, reason: 'Smartphones' },
    { ticker: 'AMZN', name: 'Amazon.com Inc.', price: '$3,000', change: '+1.3%', logo: amznLogo, reason: 'E-commerce' },
    { ticker: 'GOOGL', name: 'Alphabet Inc.', price: '$2,500', change: '+0.9%', logo: googlLogo, reason: 'Search' },
];
